    ...
    <li className="ListItem">
      {task.edit ? (
        ...
        <p
          className={
            task.completed
              ? 'ListItem__text ListItem__text--completed'
              : 'ListItem__text'
          }
          onClick={doTask}
          data-id={task.id}
      ...
      <Button
        className="btn-edit waves-effect waves-light btn"
        id={task.id}
        value={task.edit ? 'OK' : 'Edit'}
        action={task.edit ? submitEdit : toggleEdit}
      />

      <Button
        className="btn-delete waves-effect waves-light btn"
        id={task.id}
        value={task.edit ? 'Cancel' : 'Delete'}
        action={task.edit ? cancelEdit : deleteTask}
      />
